                ...
                <div class="form-step">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    <label for="realiza_entrega_cliente" class="block text-sm font-medium text-gray-700">¿Quién realiza la entrega a cliente?</label>
                                ...
                                <div>
                                    <label for="lugarentrega" class="block text-sm font-medium text-gray-700">Lugar de entrega y dirección</label>
                                ...
                                <div>
                                    <label for="tiempoentrega" class="block text-sm font-medium text-gray-700">Tiempo de entrega</label>
                                ...
                                <div>
                                    <label for="tipoicoterm" class="block text-sm font-medium text-gray-700">¿Qué tipo de incoterms aplica?</label>
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    <label for="frecuencia_suministro" class="block text-sm font-medium text-gray-700">¿Cada
                                        cuanto se va a
                                        suministrar?</label>
                ...
                <div class="form-step">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input id="formapago" type="text" wire:model="formapago" class="mt-1 block w-full rounded-md border-gray-300 {{ $errors->has('formapago') ? 'border-red-400' : 'border-blue-100' }} shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    @error('formapago')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input id="moneda" type="text" wire:model="moneda" class="mt-1 block w-full rounded-md border-gray-300 {{ $errors->has('moneda') ? 'border-red-400' : 'border-blue-100' }} shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    @error('moneda')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div>
                                    <label for="incluye_iva" class="block text-sm font-medium text-gray-700">Incluye IVA</label>
                                    <select id="incluye_iva" wire:model="incluye_iva" class="mt-1 block w-full rounded-md border-gray-300 {{ $errors->has('incluye_iva') ? 'border-red-400' : 'border-blue-100' }} shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                ...
                                <div>
                                    ...
                                    <input id="fecha_pago" type="date" wire:model="fecha_pago" class="mt-1 block w-full rounded-md border-gray-300 {{ $errors->has('fecha_pago') ? 'border-red-400' : 'border-blue-100' }} shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    @error('fecha_pago')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input id="otros" type="text" wire:model="otros" class="mt-1 block w-full rounded-md border-gray-300 {{ $errors->has('otros') ? 'border-red-400' : 'border-blue-100' }} shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    @error('otros')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div class="grid gap-4">
                                <div>
                                    <label for="aplicapoliza" class="block text-sm font-medium text-gray-700">Aplica Póliza</label>
                                    <input id="aplicapoliza" type="text" wire:model="aplicapoliza" class="mt-1 block w-full rounded-md border-gray-300 {{ $errors->has('aplicapoliza') ? 'border-red-400' : 'border-blue-100' }} shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    @error('aplicapoliza')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input id="porcentaje" type="number" step="0.01" wire:model="porcentaje" class="mt-1 block w-full rounded-md border-gray-300 {{ $errors->has('porcentaje') ? 'border-red-400' : 'border-blue-100' }} shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    @error('porcentaje')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
