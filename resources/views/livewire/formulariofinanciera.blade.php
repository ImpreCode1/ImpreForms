<div class="flex flex-col lg:flex-row h-scree">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    class="pl-12 w-full input-gradient border-2 border-blue-100 rounded-xl py-3 px-4 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-300 cursor-not-allowed"
                                    type="text" placeholder="Número de oportunidad" value="{{ $crm }}"
                                    disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="plazo" wire:model.live="plazo" autocomplete="off"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="pago" wire:model.live="pago" autocomplete="off"
                                    class="pl-12 w-full input-gradient border-2
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="garantia" wire:model.live="garantia" autocomplete="off"
                                    class="pl-12 w-full input-gradient border-2
                            ...
                            <div class="flex items-center space-x-4">
                                <label class="inline-flex items-center">
                                    <input type="radio" class="form-radio" name="hasAdvancePayment" value="si"
                                        wire:model.live="hasAdvancePayment" wire:click="setAdvancePayment('si')">
                                    <span class="ml-2 text-gray-500">Sí</span>
                                </label>
                                <label for="no" class="inline-flex items-center">
                                    <input id="no" type="radio" class="form-radio" name="hasAdvancePayment"
                                        value="no" wire:model.live="hasAdvancePayment" wire:click="setAdvancePayment('no')" checked>
                                    <span class="ml-2 text-gray-500">No</span>
                                </label>
                            </div>
                            @error('hasAdvancePayment')
                                <span class="text-sm text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div id="advancePaymentFields"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <i
                                        class="ri-percent-line absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <i
                                        class="ri-calendar-line absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <i
                                    class="ri-more-2-line absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-400"></i>
                    ...
                    <div class="flex flex-col mt-6">
                        @if ($errors->any())
                            <div class="alert alert-danger mb-4 text-center">
                                <span class="text-red-500">Parece que algunos campos del formulario aún no están
                                    completos o contienen información incorrecta.</span>
                            </div>
                        @endif
    ...
    @if (session('success'))
        <div class="w-3/5 fixed top-0  right-0 z-50 flex items-center p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg shadow-lg"
            role="alert">
            <div
        ...
        <div class="flex items-center justify-center h-full">
            <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
                ...
                <div class="mt-4 flex justify-end">
                    ...
                    <button wire:click="submit" onclick="submit()"
                        class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Sí, Enviar</button>
                </div>
            </div>
        </div>
    </div>
