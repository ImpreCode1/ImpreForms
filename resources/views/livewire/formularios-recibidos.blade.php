                                        ...
                                        <tr wire:key="formulario-{{ $formulario->id }}"
                                            ...
                                            <td class="px-2 py-3 text-center">
                                                <div class="flex justify-center space-x-1">
                                                    ...
                                                    <a href="{{ route('editar-formulario', ['id' => $formulario->id]) }}"
                                                        class="w-7 h-7 rounded-full bg-yellow-50 text-yellow-600 hover:bg-yellow-100 flex items-center justify-center"
