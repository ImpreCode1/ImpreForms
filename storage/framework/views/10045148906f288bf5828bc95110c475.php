        ...
        <aside
            ...
            <div class="px-4 py-4 border-b border-gray-100 flex-shrink-0"
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <h2 class="text-sm font-semibold text-gray-800 leading-tight"><?php echo e(Auth::user()->name); ?></h2>
                    <p class="text-xs text-gray-500 truncate max-w-full"><?php echo e(Auth::user()->email); ?></p>
                </div>
            </div>
                ...
                <div x-data="{
                    ...
                    <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route($item['route'])); ?>"
                           @click="setCurrentRoute('<?php echo e($item['route']); ?>')"
                           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 ease-in-out"
                           :class="{
                               'bg-gradient-to-r from-blue-50 to-blue-100 text-blue-600': currentRoute === '<?php echo e($item['route']); ?>',
                               'text-gray-600 hover:bg-gray-100 hover:text-gray-800': currentRoute !== '<?php echo e($item['route']); ?>',
                               'justify-center': !sidebarOpen
                           }">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                 class="w-5 h-5 flex-shrink-0 <?php echo e($item['color']); ?>"
                            ...
                            <span
                                x-show="sidebarOpen && currentRoute === '<?php echo e($item['route']); ?>'"
