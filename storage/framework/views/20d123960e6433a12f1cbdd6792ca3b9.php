        ...
        <div class="font-sans text-gray-900 antialiased">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form wire:submit.prevent="submit" id="operacionesForm" class="space-y-8">
                    <div id="step1" class="<?php echo e($currentStep === 1 ? '' : 'hidden'); ?> form-step">
                        <!-- Header Section -->
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div class="relative">
                                    <i
                                        ...
                                        <?php echo e($errors->has('tipo_solicitud') ? 'text-red-500' : 'text-gray-400'); ?>"></i>
                                    <select id="tipo_solicitud" wire:model.live="tipo_solicitud"
                                        class="mt-1 block w-full rounded-md border-gray-300
                                        <?php echo e($errors->has('tipo_solicitud') ? 'border-red-300' : 'border-blue-100'); ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tipo_solicitud'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <span class="text-sm text-red-500 text-center block"><?php echo e($message); ?></span>
                                <?php unset($message);
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="negocio" wire:model.live="negocio"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('negocio') ? 'border-red-400' : 'border-blue-100'); ?>

                                            shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['negocio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="nombre" type="text" value="<?php echo e($nombre); ?>" readonly
                                            class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50
                                            <?php echo e($errors->has('nombre') ? 'border-red-400' : 'border-blue-100'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="nom_rep" type="text" wire:model.live="nom_rep"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('nom_rep') ? 'border-red-400' : 'border-blue-100'); ?>

                                            shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nom_rep'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="correo" type="email" wire:model.live="correo"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('correo') ? 'border-red-400' : 'border-blue-100'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="numero" type="text" wire:model.live="numero"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('numero') ? 'border-red-400' : 'border-blue-100'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="crm" type="text" wire:model.live="crm"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('crm') ? 'border-red-400' : 'border-blue-100'); ?>

                                            shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['crm'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <select id="incluye_iva" wire:model="incluye_iva"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('incluye_iva') ? 'border-red-400' : 'border-blue-100'); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['incluye_iva'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="precio" type="text" wire:model.live="precio"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('precio') ? 'border-red-400' : 'border-blue-100'); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <select id="moneda_precio_venta" wire:model="moneda_precio_venta"
                                            class="mt-1 block w-full rounded-md border-gray-300
                                            <?php echo e($errors->has('moneda_precio_venta') ? 'border-red-400' : 'border-blue-100'); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['moneda_precio_venta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="grid grid-cols-1 gap-4">
                                        <div>
                                            ...
                                            <select id="soluciones" wire:model.live="soluciones"
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('soluciones') ? 'border-red-400' : 'border-blue-100'); ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['soluciones'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="codlinea" wire:model.live="codlinea"
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('codlinea') ? 'border-red-400' : 'border-blue-100'); ?>

                                                shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['codlinea'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <input id="linea" type="text" value="<?php echo e($linea); ?>"
                                                readonly
                                                class="mt-1 block w-full rounded-md border-gray-300 bg-gray-50
                                                <?php echo e($errors->has('linea') ? 'border-red-400' : 'border-blue-100'); ?>

                                                shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['linea'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <input id="nomgerente" type="text" wire:model.live="nomgerente"
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('nomgerente') ? 'border-red-400' : 'border-blue-100'); ?>

                                                shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['nomgerente'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <input id="corgerente" type="text" wire:model.live="corgerente"
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('corgerente') ? 'border-red-400' : 'border-blue-100'); ?>

                                                shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['corgerente'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select id="nombre_dir" wire:model.live="selectedDirector"
                                                ...
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('selectedDirector') ? 'border-red-400' : 'border-blue-100'); ?>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $Directores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Director): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($Director->id); ?>">
                                                        <?php echo e($Director->nombre_director); ?>

                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                            </select>
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedDirector'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <input id="DirectorEmail" type="text" wire:model.live="DirectorEmail"
                                                value="<?php echo e($DirectorEmail); ?>"
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('DirectorEmail') ? 'border-red-400' : 'border-blue-100'); ?>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select id="nombre_ejc" wire:model.live="selectedEjecutivo"
                                                ...
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('selectedEjecutivo') ? 'border-red-400' : 'border-blue-100'); ?>

                                                shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                                <option value="">Seleccione un Ejecutivo</option>
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $Ejecutivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Ejecutivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($Ejecutivo->id); ?>">
                                                        <?php echo e($Ejecutivo->nombre_colaborador); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                            </select>
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['selectedEjecutivo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <input id="EjecutivoEmail" type="text"
                                                wire:model.live="EjecutivoEmail" value="<?php echo e($EjecutivoEmail); ?>"
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('EjecutivoEmail') ? 'border-red-400' : 'border-blue-100'); ?>
                                    ...
                                    <div class="grid md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" wire:model.live="clientcode"
                                                class="mt-1 block w-full rounded-md border-gray-300
                                                <?php echo e($errors->has('clientcode') ? 'border-red-400' : 'border-blue-100'); ?>

                                                shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200"
                                                placeholder="Opcional" />
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['clientcode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <input type="text" wire:model.live="clientname"
                                                ...
                                                placeholder="Opcional" />
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['clientname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            ...
                                            <input type="text" wire:model.live="mail"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200"
                                                placeholder="Opcional" />
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['mail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div id="step2" class="<?php echo e($currentStep === 2 ? '' : 'hidden'); ?> form-step">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-gray-50 p-6 rounded-lg">
                                <h2 class="text-2xl font-semibold text-gray-700 mb-4 border-b pb-2 flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-yellow-500"
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input id="entregacliente" type="text" wire:model.live="entregacliente"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('entregacliente') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['entregacliente'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="entrega_realizar" type="text"
                                            ...
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('entrega_realizar') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['entrega_realizar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="lugarentrega" type="text" wire:model.live="lugarentrega"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('lugarentrega') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['lugarentrega'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="espais" type="text" wire:model.live="espais"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('espais') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['espais'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="tiempoentrega" type="text" wire:model.live="tiempoentrega"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('tiempoentrega') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tiempoentrega'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="terminoentrega" type="date" wire:model.live="terminoentrega"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('terminoentrega') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['terminoentrega'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="tipoicoterm" type="text" wire:model.live="tipoicoterm"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('tipoicoterm') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tipoicoterm'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input id="prestar" type="text" wire:model.live="prestar"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('prestar') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['prestar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="suministrar" type="text" wire:model.live="suministrar"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('suministrar') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['suministrar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="inicio" type="date" wire:model.live="inicio"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('inicio') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['inicio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input id="finalizacion" type="date" wire:model.live="finalizacion"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('finalizacion') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['finalizacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <input id="forma_pago" type="text" wire:model.live="forma_pago"
                                        class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('forma_pago') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['forma_pago'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div>
                                    ...
                                    <input id="fecha_cada_pago" type="text" wire:model.live="fecha_cada_pago"
                                        class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('fecha_cada_pago') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['fecha_cada_pago'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div>
                                    ...
                                    <select id="moneda" wire:model="moneda"
                                        class="mt-1 block w-full rounded-md border-gray-300
                                        <?php echo e($errors->has('moneda') ? 'border-red-400' : 'border-blue-100'); ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['moneda'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['incluir_iva'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="flex items-center">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['hay_anticipo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                        <span class="text-red-500 text-sm ml-2"><?php echo e($message); ?></span>
                                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="mt-3">
                                    ...
                                    <input id="porcentaje_anticipo" type="number" step="1" min="0"
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300
                                        <?php echo e($errors->has('porcentaje_anticipo') ? 'border-red-400' : 'border-blue-100'); ?>

                                        shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['porcentaje_anticipo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div>
                                    ...
                                    <input id="fecha_pago_anticipo" type="date"
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('fecha_pago_anticipo') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['fecha_pago_anticipo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div>
                                    ...
                                    <input id="otros_pago" type="text" wire:model.live="otros_pago"
                                        class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('otros_pago') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['otros_pago'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid gap-4">
                                <div>
                                    ...
                                    <select wire:model.live="aplicagarantia" id="garantia"
                                        class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('aplicagarantia') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                        <option value="" disabled>Selecciona una opción</option>
                                        <option value="si">Sí</option>
                                        <option value="no">No</option>
                                    </select>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['aplicagarantia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($aplicagarantia === 'si'): ?>
                                    <div>
                                        ...
                                        <input id="terminogarantia" type="text" wire:model="terminogarantia"
                                            class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('terminogarantia') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['terminogarantia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid gap-4">
                                <div>
                                    ...
                                    <select wire:model.live="aplicapoliza" id="aplicapoliza"
                                        class="mt-1 block w-full rounded-md border-gray-300 <?php echo e($errors->has('aplicapoliza') ? 'border-red-400' : 'border-blue-100'); ?> shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200">
                                        <option value="" disabled>Selecciona una opción</option>
                                        <option value="si">Sí</option>
                                        <option value="no">No</option>
                                    </select> <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['aplicapoliza'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div>
                                    <!--[if BLOCK]><![endif]--><?php if($aplicapoliza === 'si'): ?>
                                        ...
                                        <div class="relative mt-1">
                                            <input id="porcentaje" type="number" step="1"
                                                ...
                                                class="block w-full pr-10 rounded-md border-gray-300
                                                        <?php echo e($errors->has('porcentaje') ? 'border-red-400' : 'border-blue-100'); ?>
                            ...
                            <div class="border-dashed border-2 border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors duration-300"
                                ...
                                <ul>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><?php echo e($file['name']); ?> (<?php echo e($file['size']); ?> KB)</li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </ul>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!-- Lista de documentos -->
                             <!--[if BLOCK]><![endif]--><?php if(count($files) > 0): ?>
                                <div class="mt-4">
                                    ...
                                    <ul class="space-y-2">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li wire:key="file-<?php echo e($id); ?>"
                                                ...
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div class="flex flex-col">
                                                        <span
                                                            class="text-sm font-medium text-gray-700"><?php echo e($file['name']); ?></span>
                                                        <span class="text-xs text-gray-500"><?php echo e($file['size']); ?>

                                                            KB</span>
                                                    </div>
                                                </div>
                                                <button type="button"
                                                    wire:click="removeFile('<?php echo e($id); ?>')"
                            ...
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <div class="flex flex-col mt-6"> <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['archivos.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\laragon\www\ImpreForms\resources\views/livewire/enviar-formulario.blade.php ENDPATH**/ ?>