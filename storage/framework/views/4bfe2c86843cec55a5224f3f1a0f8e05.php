  ...
  <div class="w-full max-w-4xl bg-white shadow-2xl rounded-3xl overflow-hidden grid md:grid-cols-2">
    ...
    <div class="bg-gradient-to-br from-[#6a11cb] to-[#2575fc] flex items-center justify-center p-12 relative">
      <div class="text-white text-center z-10">
        <!-- Logo -->
        <img src="<?php echo e(asset('images/logo-impreforms.png')); ?>" alt="Logo ImpreForms"
      ...
      <form wire:submit="login" class="w-full space-y-6" novalidate>
        ...
        <div class="relative">
            <input
                ...
                class="w-full px-4 py-3.5 pl-10 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-indigo-200 <?php $__errorArgs = ['form.email'];
        ...
        <div class="relative">
          <input
            ...
            class="w-full px-4 py-3.5 pl-10 rounded-xl border-2 border-gray-200
                   ...
                   transition duration-300 ease-in-out <?php $__errorArgs = ['form.password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php unset($message);
...
</div><?php /**PATH C:\laragon\www\ImpreForms\resources\views\livewire/pages/auth/login.blade.php ENDPATH**/ ?>