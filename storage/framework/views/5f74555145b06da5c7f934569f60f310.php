                                ...
                                <form wire:submit.prevent="importColaboradores" class="space-y-4">
                                    <div class="flex items-center justify-center w-full">
                                        <label class="flex flex-col items-center justify-center w-full h-48 border-2 border-blue-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-blue-50 transition duration-300">
                                            <!--[if BLOCK]><![endif]--><?php if(isset($archivoColaboradores) && $archivoColaboradores): ?>
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <p class="text-sm text-gray-500 mt-2">
                                                        <?php echo e($archivoColaboradores->getClientOriginalName()); ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['archivoColaboradores'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <button
                                        type="submit"
                                        <?php if(!isset($archivoColaboradores) || !$archivoColaboradores): ?> disabled <?php endif; ?>
                        ...
                        <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-2xl">
                            ...
                            <div class="p-6">
                                ...
                                <a href="<?php echo e(route('admin.maestros.ejecutivos')); ?>" class="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition duration-300 flex items-center justify-center">
                        ...
                        <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-2xl">
                            ...
                            <div class="p-6">
                                ...
                                <a href="<?php echo e(route('admin.maestros.directores')); ?>" class="w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition duration-300 flex items-center justify-center">
                        ...
                        <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-2xl">
                            ...
                            <div class="p-6">
                                ...
                                <a href="<?php echo e(route('admin.maestros.lineas')); ?>" class="w-full bg-amber-600 text-white py-3 rounded-lg hover:bg-amber-700 transition duration-300 flex items-center justify-center">
                        ...
                        <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-2xl">
                            ...
                            <div class="p-6">
                                ...
                                <a href="<?php echo e(route('admin.maestros.codigos-cliente')); ?>" class="w-full bg-purple-600 text-white py-3 rounded-lg hover:bg-purple-700 transition duration-300 flex items-center justify-center">
...
<?php /**PATH C:\laragon\www\ImpreForms\resources\views/livewire/cargar-reporte.blade.php ENDPATH**/ ?>